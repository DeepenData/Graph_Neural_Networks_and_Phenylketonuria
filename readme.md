# Underlying genotype-phenotype relationship of an inborn error on metabolism analyzed via genome-scale metabolic modeling and graph deep neural networks
