...
generate_right_swarms(metabolites_outliers_imputed)
...
generate_right_swarms(aug_PKUs, color_1 = "darkorange", color_2 = "darkorange")
```
...
b_subplot <- plot_split_violins(augmented_data, 4 , vars_by_quntl, 'none', F, 1, .1)
b_subplot +  scale_shape_manual(values = c(0.001, 0.001))
