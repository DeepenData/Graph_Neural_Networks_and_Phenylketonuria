...
df_flux     <-    read_csv("./results/dataframes/new_to_R_heatmap_explanatory_subgraph_MASKED_GIN_Fluxes.csv") %>% dplyr::select(-c("...1"))
...
data_plus_labels <- get_processed_data(df_flux, .95, labels_flux)
...
write_csv(edges_genes_SAMPLE,  "./results/dataframes/new_to_visualization_explanatory_subgraph_MASKED_GIN_FLUX.csv")
...
df_flux     <-    read_csv("./results/dataframes/new_to_R_heatmap_explanatory_subgraph_MASKED_GIN_Concentration.csv") %>% dplyr::select(-c("...1"))
...
data_plus_labels <- get_processed_data(df_flux, .995, labels_flux)
...
write_csv(edges_genes_SAMPLE,  "./results/dataframes/new_to_visualization_explanatory_subgraph_MASKED_GIN_Concentration.csv")
...
df_flux     <-    read_csv("./results/dataframes/new_to_R_heatmap_explanatory_subgraph_MASKED_GIN_Concen_plus_Fluxes.csv") %>% dplyr::select(-c("...1"))
...
data_plus_labels <- get_processed_data(df_flux, .99, labels_flux)
...
write_csv(edges_genes_SAMPLE,  "./results/dataframes/new_to_visualization_explanatory_subgraph_MASKED_GIN_Concen_plus_Fluxes.csv")
