...
df     <-  read_csv("./results/dataframes/to_R_heatmap_explanatory_subgraph_MASKED_GCN_Concentration.csv") %>% dplyr::select(-c("...1")) #to_R_heatmap_explanatory_subgraph_masked_NONflux.csv #to_R_heatmap_explanatory_subgraph_masked_FLUX.csv
labels <- read_csv("./results/dataframes/labels_masked_only_Concen.csv")  %>%  dplyr::select(-c("...1")) %>% .[[1]] #test_labels_masked_NONflux.csv  #test_labels_masked_FLUX.csv
                                                                      ...
                                                                      if(small){
                                                                               top_annotation <- columnAnnotation(
                                                                                ...
                                                                                ht <- Heatmap( t(processed_data_df_sorted), 
                                                                                                ...
                                                                                                column_title = c( "> 90% Percentile (5045 edges)"),
                                                                                                border = TRUE)
                                                                                               return(ht)
                                                                                                } else{
                                                                                                                                                                                 top_annotation <- columnAnnotation(
                                                                                ...
                                                                                ht <- Heatmap( t(processed_data_df_sorted), 
                                                                                               ...
                                                                                               #column_title = c( "> 99% Percentile (505 edges)")
                                                                                               )
...
#df     <-  read_csv("./results/dataframes/to_visualization_explanatory_subgraph_MASKED_GCN_Concentration.csv") #%>% dplyr::select(-c("...1")) #to_R_heatmap_explanatory_subgraph_masked_NONflux.csv #to_R_heatmap_explanatory_subgraph_masked_FLUX.csv
setwd("/DeepenData/Repos/geometric_cobra")

write_csv(df[mask, ], "./results/dataframes/to_visualization_explanatory_subgraph_MASKED_GCN_Concentration.csv")
```
