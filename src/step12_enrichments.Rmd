...
annotate_figure(concentration_panel,
             ...
             left = text_grob(" Transporters                                Reactions", color = "black", rot = 90,  size = 8),) -> concentration_panel_final
...
setwd("/DeepenData/Repos/geometric_cobra")
ggsave("./results/figures/figure_4.png", full_panel, height = 4, width = 12, bg="white")
