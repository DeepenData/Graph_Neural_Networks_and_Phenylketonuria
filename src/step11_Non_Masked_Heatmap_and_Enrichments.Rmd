...
df     <-  read_csv("./results/dataframes/to_R_heatmap_explanatory_subgraph_masked_NONflux.csv") %>% dplyr::select(-c("...1")) #to_R_heatmap_explanatory_subgraph_masked_NONflux.csv #to_R_heatmap_explanatory_subgraph_masked_FLUX.csv
labels <- read_csv("./results/dataframes/test_labels_masked_NONflux.csv")  %>%  dplyr::select(-c("...1")) %>% .[[1]] #test_labels_masked_NONflux.csv  #test_labels_masked_FLUX.csv
