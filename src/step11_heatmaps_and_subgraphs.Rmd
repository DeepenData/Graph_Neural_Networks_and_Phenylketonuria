...
make_panel <- function(df, labels, if_export, subgraph_exporting_path, graph_subplot_image_path, cutoff_narrow_heatmap, subplot_labels ){
                      ...
                      ggarrange(subgraph_subplot, subplots_flux[[2]]  %>% ggplotify::as.ggplot(), widths = c(1,1), labels = subplot_labels[[1]] , vjust = .9, hjust = .13) -> lower_panel
...
df_conc     <-  read_csv("./results/dataframes/new_to_R_heatmap_explanatory_subgraph_MASKED_GIN_Concentration.csv") %>% dplyr::select(-c("...1")) #to_R_heatmap_explanatory_subgraph_masked_NONflux.csv #to_R_heatmap_explanatory_subgraph_masked_FLUX.csv
labels_conc <- read_csv("./results/dataframes/labels_masked_only_Concen.csv")  %>%  dplyr::select(-c("...1")) %>% .[[1]] #test_labels_masked_NONflux.csv  #test_labels_masked_FLUX.csv

make_panel(df_conc, labels_conc, F, "",  "./results/figures/Figure_2_MASKED_Concentration.png", .995, list(c('b', 'c'),c("a",""))) -> upper_panel;
upper_panel[[1]]
```
...
df_flux     <-  read_csv("./results/dataframes/new_to_R_heatmap_explanatory_subgraph_MASKED_GIN_Fluxes.csv") %>% dplyr::select(-c("...1")) #to_R_heatmap_explanatory_subgraph_masked_NONflux.csv #to_R_heatmap_explanatory_subgraph_masked_FLUX.csv
...
make_panel(df_flux, labels_flux, F, "",  "./results/figures/Figure_2_MASKED_FLUX.png", .95, list(c('e', 'f'),c("d",""))) -> middle_panel;
middle_panel[[1]]
```
...
df_flux     <-  read_csv("./results/dataframes/new_to_R_heatmap_explanatory_subgraph_MASKED_GIN_Concen_plus_Fluxes.csv") %>% dplyr::select(-c("...1")) #to_R_heatmap_explanatory_subgraph_masked_NONflux.csv #to_R_heatmap_explanatory_subgraph_masked_FLUX.csv
...
make_panel(df_flux, labels_flux, F, "",  "./results/figures/Figure_2_MASKED_Concen_plus_Fluxes.png", .99, list(c('h', 'i'),c("g",""))) -> lower_panel;
lower_panel[[1]]
```
...
#upper_panel[[1]], middle_panel[[1]], lower_panel[[1]], 



get_clusters_and_check(upper_panel, "./results/dataframes/new_to_visualization_explanatory_subgraph_MASKED_GIN_Concentration.csv") -> concentration 
get_clusters_and_check(middle_panel, "./results/dataframes/new_to_visualization_explanatory_subgraph_MASKED_GIN_FLUX.csv") -> flux 
get_clusters_and_check(lower_panel, "./results/dataframes/new_to_visualization_explanatory_subgraph_MASKED_GIN_Concen_plus_Fluxes.csv") -> concentration_plus_flux 
