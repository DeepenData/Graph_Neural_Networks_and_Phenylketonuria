...
```{r fig.height=16, fig.width=18, message=FALSE, warning=FALSE}
...
ggarrange(enrichment_panel, volcanos_panel, nrow = 1, widths = c(1,2)) -> full_panel
...
```{r}
setwd("/DeepenData/Repos/geometric_cobra")
ggsave("./results/figures/Figure_4.png", full_panel, height = 12, width = 15.5, bg="white", dpi = 400)
