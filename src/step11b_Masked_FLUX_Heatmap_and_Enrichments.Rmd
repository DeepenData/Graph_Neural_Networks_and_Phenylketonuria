...
ggarrange(upper_panel[[1]], middle_panel[[1]], lower_panel[[1]], ncol = 1)
...
setwd("/DeepenData/Repos/geometric_cobra")
read_csv("./results/dataframes/to_visualization_explanatory_subgraph_MASKED_GCN_Concentration.csv")

heatmap_clusters <- waRRior::heatmap_extract_cluster(draw(upper_panel[[1]]), t(processed_data),  which = "column")
```
