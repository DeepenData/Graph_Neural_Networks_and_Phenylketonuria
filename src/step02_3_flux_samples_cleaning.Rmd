...
flux_samples_CONTROL_10_000 <- arrow::read_parquet("./results/fluxes/flux_samples_CONTROL_20_000.parquet.gzip") %>% remove_outliers_patients(0.01, .99)
flux_samples_PKU_10_000 <- arrow::read_parquet("./results/fluxes/flux_samples_PKU_20_000.parquet.gzip")%>% remove_outliers_patients(0.01, .99)
```
