...
enrich_output %>% dotplot(showCategory = 5, font.size = 9, label_format =40) ->enrichGO 
```
...
clusters_list%>% compareCluster(fun='enrichDGN', pvalueCutoff=1e-3)-> enrich_output


enrich_output %>% dotplot(showCategory = 5, font.size = 9, label_format =40) -> enrichDGN
```
...
panel_non_MASKED <-  ggarrange(HTMP, enrich_panel, heights = c(1,.9) , ncol = 1)
panel_non_MASKED
```
...
ggsave("./results/figures/panel_non_MASKED.png", panel_non_MASKED, height = 11, width = 13, dpi = 200, bg = "white")
