...
make_panel(df_conc, labels_conc, F, "",  "./results/figures/Figure_3_subplot_Concentration.png", .995, list(c('b', 'c'),c("a",""))) -> upper_panel;
#upper_panel[[1]]
```
...
make_panel(df_flux, labels_flux, F, "",  "./results/figures/Figure_3_subplot_FLUX.png", .95, list(c('e', 'f'),c("d",""))) -> middle_panel;
#middle_panel[[1]]
```
